...
lint:
	...
	@$(QUIET) find . -not -path '*/\.*' | xargs file | egrep "shell script|bash script" | grep -v directory | awk '{ print $$1 }' | sed 's/://g' | grep -v dokku_client.sh | xargs shellcheck -e SC2034,SC2086,SC2143,SC2001
