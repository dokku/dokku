...
.PHONY: all install copyfiles alias version plugins dependencies sshcommand pluginhook docker aufs stack count

all:
	# Type "make install" to install.

install: dependencies stack copyfiles alias plugins version
...
alias:
	touch /home/dokku/ALIAS
	chown dokku:dokku /home/dokku/ALIAS
	while read line; do \
	  cmd=$$(echo $$line | cut -d'=' -f1); \
	  grep -q "^$$cmd=" /home/dokku/ALIAS || echo "$$line" >> /home/dokku/ALIAS; \
	done < ALIAS
