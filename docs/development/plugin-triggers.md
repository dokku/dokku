...
!!! warning
    The `git-pre-pull` trigger should _not_ be used for authentication
...
!!! info "To avoid uninstalling other plugins make sure to check the plugin name like shown in the example."
