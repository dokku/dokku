...
!!! info
    To execute commands on the host during a release phase, see the [plugin creation documentation](/development/plugin-creation) docs for more information on building your own custom plugin.
