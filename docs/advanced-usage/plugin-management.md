...
plugn: dev
  ...
  build-env            0.24.4 enabled    dokku core build-env plugin
  ...
  docker-options       0.24.4 enabled    dokku core docker-options plugin
  domains              0.24.4 enabled    dokku core domains plugin
  ...
  network              0.24.4 enabled    dokku core network plugin
  ...
  storage              0.24.4 enabled    dokku core storage plugin
