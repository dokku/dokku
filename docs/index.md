...
If you wish for a more unattended installation method, see [these](/getting-started/install/debian/#unattended-installation) docs.

### Upgrade

[View the docs](/getting-started/upgrading/) for upgrading from an older version of Dokku.
...
You can use [Github Issues](https://github.com/dokku/dokku/issues), check [Troubleshooting](/getting-started/troubleshooting/) in the documentation, or join us on [freenode in #dokku](https://webchat.freenode.net/?channels=%23dokku).

## Contribution

After checking [Github Issues](https://github.com/dokku/dokku/issues), the [Troubleshooting Guide](/getting-started/troubleshooting/) or having a chat with us on [freenode in #dokku](https://webchat.freenode.net/?channels=%23dokku), feel free to fork and create a Pull Request.
