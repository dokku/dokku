  ...
  <div class="quickstart-code">
    ...
    <div class="shell">
      <p class="line">
        ...
        <span class="command">wget https://raw.githubusercontent.com/dokku/dokku/v0.5.5/bootstrap.sh</span>
      </p>
      <p class="line">
        <span class="path">~</span>
        <span class="prompt">$</span>
        <span class="command">sudo DOKKU_TAG=v0.5.5 bash bootstrap.sh</span>
      </p>
      <p class="line">
