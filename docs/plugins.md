...
| [Monit](https://github.com/cjblomqvist/dokku-monit)<sup>1</sup>                                   | [cjblomqvist][]       |                       |
...
<sup>1</sup> This plugin is far from complete and a mere proof-of-concept of how Monit can be used to externally monitor dokku apps. Read the [README](https://github.com/cjblomqvist/dokku-monit) for more details or contact the author.
